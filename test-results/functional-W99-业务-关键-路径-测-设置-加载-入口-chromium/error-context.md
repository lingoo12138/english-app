...
- Name: functional.spec.ts >> W99 业务 关键 路径 测 >> 设置 加载 + 入口
- Location: e2e/functional.spec.ts:37:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_RESET at https://lingoo12138.github.io/english-app/settings
Call log:
  - navigating to "https://lingoo12138.github.io/english-app/settings", waiting until "domcontentloaded"
