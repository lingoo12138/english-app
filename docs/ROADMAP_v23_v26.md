...
| 周 | 版本 | 计划 | 实际 |
|----|------|------|------|
| W1 | v0.23 | 写作批改 4.5d + 每日一句跟读 1d + 对话中收藏 1d = 6.5d | **1.5d** |
| W2 | v0.24 | AI 实时纠错 4.5d | **1d** |
| W3 | v0.25 | 词根扩充 2.5d + 改错本 2.5d = 5d | **1d** |
| W4 | v0.26 | 听力模式 2.5d + P2 收尾 1.5d + 缓冲 1d = 5d | **1.5d** |
| **总** | v0.23 - v0.26 | **21.5d** | **5d** |
...
**显式不做保留**:
- ❌ 微信小程序
- ❌ 47 P2 全清 (挑高 ROI 5-8 个, 实际做了 8 个)
- ❌ 多端同步 / 账号 / 社区
- ❌ 离线对话
- ❌ 中译英 Tab (W1 砍)

**北极星对齐**: 让英语在你想用的时候就能用上 ✅
- 触发可及: Daily + Home + Plan 3 入口
- 内容能用: 5334 词 + 13234 句 + 5 场景 + 5 听力
- 学得会: AI 写作批改 + 实时纠错 + 改错本 + 跟读评测
