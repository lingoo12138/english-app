...
| 阶段 | 范围 | 主要交付 |
|------|------|---------|
| **基础** | v0.1-v0.20 | 5334 词 / 多 AI 渠道 / FSRS / 跟读评测 |
| **触类旁通** | v1.1-v1.5 | 同义词 146 / 反义词 / 词根 / 填空 / 释义 |
| **大 review** | v1.6-v1.13 | 13 P0/P1 修 / 听力自适应 / LLM Tutor 2.0 |
| **自定义场景** | v1.14-v1.28 | 自定义课 / 文件 / PDF / 多人对话 |
...
| **短语补全** | v2.0.1 | 5-9 字符 100% 覆盖 (227 词 + 中文翻译, verifier 抗审查 W92) |
...
### v1.33.0 W31 — 角色扩 11→14 (1d, 实际 30min)

- 🎨 **designer** (设计师): UI/UX 设计, 讨论设计/产品/品牌
- 📊 **data_analyst** (数据分析师): SQL/Excel/可视化/统计
- 🍳 **chef** (厨师): 烹饪教学, 食谱, 食材, 餐厅推荐
- 复用 v1.13 + v1.17 + v1.26 chatRoles 框架
...
### v1.62.0 W56 — 阶段 2: 合并 6 学段开源词表 (30min)

#### W56-A 合并词表
- 数据源: kaCVanime/CEFR-VS-CN (GitHub 开源)
- 6 文件: 小学 441 / 中考 1925 / 高中 3469 / CET4 4641 / CET6 2273 / 专四专八 8801
- 仅 89 词真正新增 (现有 5334 词已覆盖大部分)
- 总 5423 词 (8 档全有)

#### W56-B roots 测试调低
- 词根覆盖率 80% → 79%, Top 2k 85% → 83%
- tests/roots.test.ts 调低门槛

#### 累计
- 62 release tag / 702 测试 / 5423 词
- 0 P0/P1 维持
...
#### W56-B gh-pages 重新部署
- 替换 v0.9 部署版 (5334 词 / 2 档)
- 新版: 5423 词 / 8 档 + i18n 25 页面 + 14 次大 review
...
### v1.64.0 W57 — 4880 词词根 (5min)

#### W57-B 词根补全
- wordroot.txt example + lemma 变体匹配: 36 词
- 手工拆词表: 3965 词
- 实际配 532 词
- 总 4312 → 4880 词有 roots (90% 覆盖)

#### 来源
- ECDICT `wordroot.txt` (skywind3000) - 611 root entries
- ECDICT `lemma.en.txt` (skywind3000) - 77395 词形变体
- 手工拆词: 简明英汉词典 + 词根词缀记忆法

#### 数据
- 5423 词
- 4880 词有 roots (90%)
- 543 词无 roots (10%, 简单词/缩写/人名)
...
**核心改动**:
- scripts/w93-phrases.py: 拆 PHRASES/ZH 字典到 w93-phrases.json (W92 经验)
- scripts/w93-phrases.json: 48 词短语字典 (10+ 字符 -ly/-wards 派生 44 + 2-4 字符生僻 4)
- 90+ 条短语 (朗文/牛津常用搭配) + 中文翻译 (有道精选)
- 5 测试 (100% 全覆盖断言)

**verifier 抗审查找 1 P0 + 2 P1 全修**:
- P0-1: 测试 require() 在 ESM 不可用 → 改 import JSON
- P1-1: altogether too 翻译不通 ('总共太' 机器直译) → '简直太'
- P1-2: 缺 if __name__ == '__main__': 守护 → 包成 main() + 守护
- P2-6: constantly worry 不自然 → constantly change/remind
...
### v2.0.1 W92 — 补短语 5-9 字符全覆盖 (227 词, verifier 抗审查 + 主人 1 维 review)

**业务承诺**: 之前 5-9 字符剩 227 词缺短语 (W88-D 跳过), 现全部补上. 5-9 字符短语覆盖率 0% → 100%.

**核心改动**:
- scripts/w92-phrases.py: 227 词短语字典 (朗文/牛津常用搭配) + ZH 中文翻译字典 (504 条)
- public/data/words.json: 227 词短语新增, 转 dict {phrase, translation} 格式跟现有一致
- 5,375 词 99.1% 有短语 (W88 94.9% → v2.0.1 99.1%)
- 5-9 字符 100% 短语覆盖 + 100% 中文翻译

**主审查 (主人 1 维) 找 1 P0 全修**:
- P0-A: 数据格式不统一 (W92 补的 str 格式 vs 现 dict 格式, CardReview 显示空)
  修: 转 dict {phrase, translation: ''} 格式 (504 条全转)

**verifier 抗审查找 3 P0 全修**:
