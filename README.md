...
[📦 v1.15.0 Release Notes](./docs/RELEASE_v1.15.0.md) ·
...
✅ **16 个版本量产** (v1.1.0 ~ v1.15.0, 3 producer 并行 1d 干完 3-6d 计划 × 9 轮)
✅ **372 单元测试 + 16 闭环集成测试** 全过 (104 → 372, +268)
...
- **250+ commit / 16 release tag (v1.0.0 ~ v1.15.0)**
