...
[📦 v1.20.0 Release Notes](./docs/RELEASE_v1.20.0.md) ·
...
✅ **21 个版本量产** (v1.1.0 ~ v1.20.0, 3 producer 并行 1d 干完 3-6d 计划 × 14 轮)
✅ **460 单元测试 + 16 闭环集成测试** 全过 (104 → 460, +356)
...
- **300+ commit / 21 release tag (v1.0.0 ~ v1.20.0)**
