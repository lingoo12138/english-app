...
[📦 v1.16.0 Release Notes](./docs/RELEASE_v1.16.0.md) ·
...
✅ **17 个版本量产** (v1.1.0 ~ v1.16.0, 3 producer 并行 1d 干完 3-6d 计划 × 10 轮)
✅ **390 单元测试 + 16 闭环集成测试** 全过 (104 → 390, +286)
...
- **260+ commit / 17 release tag (v1.0.0 ~ v1.16.0)**
