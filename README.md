...
[📦 v1.22.0 Release Notes](./docs/RELEASE_v1.22.0.md) ·
...
✅ **23 个版本量产** (v1.1.0 ~ v1.22.0, 3 producer 并行 1d 干完 3-6d 计划 × 16 轮)
✅ **510 单元测试 + 16 闭环集成测试** 全过 (104 → 510, +406)
...
- **320+ commit / 23 release tag (v1.0.0 ~ v1.22.0)**
