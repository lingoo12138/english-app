...
[📦 v1.23.0 Release Notes](./docs/RELEASE_v1.23.0.md) ·
...
✅ **526 单元测试 + 16 闭环集成测试** 全过 (104 → 526, +422)
...
| v1.13.0 | **🎭 多角色对话 (5 角色 + "普通")** | ✅ |
| v1.14.0 | **📝 自定义场景课 (粘贴文本 → AI 提取生词)** | ✅ |
| v1.15.0 | **📚 自定义场景学习流 (卡片翻页 + TTS + 进度)** | ✅ |
| v1.16.0 | **🔗 多场景关联 (CustomSceneLearn 学完 → 入复习)** | ✅ |
| v1.17.0 | **🎭 多角色扩展 (5 → 8 角色: 医生/银行/警察)** | ✅ |
| v1.18.0 | **📁 文件上传 (TXT/MD 1MB, 闭环 v1.14 自定义场景)** | ✅ |
| v1.19.0 | **📅 学习日历 (月历 + 热力图, 复用 v1.11 learningReport)** | ✅ |
| v1.20.0 | **📚 生词本批量操作 (入复习/导出CSV/全选/反选)** | ✅ |
| v1.21.0 | **🏷️ 生词本标签 (IDB v6 + 过滤 + 启发式)** | ✅ |
| v1.22.0 | **🔍 复习按 tag 过滤 (复用 v1.11 + v1.21)** | ✅ |
| v1.23.0 | **📄 PDF 上传 (懒加载 pdfjs, 闭环 v1.18 文件上传)** | ✅ |
...
## 🎭 v1.13.0 - 多角色对话 (2026-07-25) - W14+ 候选 B3

- 🎭 **5 角色**: 💼 面试官 / ☕ 咖啡师 / 🏨 酒店前台 / 🗺️ 导游 / 🍽️ 餐厅服务员
- 💬 **普通对话**: 维持 v1.9.0 自由聊天
- 🎚️ **难度自适应**: 角色 + A1-C2 注入
- 🎨 **RoleSelector**: 横向 scroll 卡片 + a11y radio + 选中高亮
- 🔄 **切角色清空历史 + 问候语 + Toast**
- 📈 288 → 324 单元测试 (+36)

详情见 [CHANGELOG v1.13.0](./docs/CHANGELOG.md#v1130---2026-07-25-w14-自主选)

## 📝 v1.14.0 - 自定义场景课 (2026-07-25) - W15 候选 B4

- 📝 **自定义场景**: 粘贴文本 (10000 字符) → AI 提取 5-30 词 → 保存为场景
- 🛠️ **mock fallback**: 词频统计 + 停用词过滤
- 🔒 **严格 JSON 解析** + 字段验证 + 难度降级
- 💾 **IDB v5** 加 `customScenes` 表
- 🛡️ **LLM 日限**: 复用 explain 30 上限
- 🏠 **Home 紫色卡片** 入口
- 📈 324 → 356 单元测试 (+32)

详情见 [CHANGELOG v1.14.0](./docs/CHANGELOG.md#v1140---2026-07-25-w15-自主选)

## 📚 v1.15.0 - 自定义场景学习流 (2026-07-25) - W16

- 📚 **卡片学习流**: 翻面 (词 ↔ 释义+例句) + 翻页 (←/→)
- ⌨️ **键盘快捷键**: 空格=翻面, ←/→=翻页
- 📊 **进度条 + 持久化** (localStorage)
- 🔊 **TTS 复用** (8 渠道)
- ⭐ **收藏 toggle** 集成
- 🎉 **完成态** + 重置
- 📈 356 → 372 单元测试 (+16)

详情见 [CHANGELOG v1.15.0](./docs/CHANGELOG.md#v1150---2026-07-25-w16)

## 🔗 v1.16.0 - 多场景关联 (2026-07-25) - W17

- 🔗 **多场景关联**: v1.14 + v1.15 + v1.11 完整闭环
- 📚 **学完入复习**: SM-2 初始值 + `customScene:` 前缀
- 📊 **复习状态卡片** (总/复习/已掌握 3 列)
- 🏷️ **列表复习中标签** (感知闭环)
- 🚫 **幂等**: 跳过已存, 不覆盖进度
- 📈 372 → 390 单元测试 (+18)

详情见 [CHANGELOG v1.16.0](./docs/CHANGELOG.md#v1160---2026-07-25-w17)

## 🎭 v1.17.0 - 多角色扩展 (2026-07-25) - W18
...
详情见 [CHANGELOG v1.17.0](./docs/CHANGELOG.md#v1170---2026-07-25-w18)

## 📁 v1.18.0 - 文件上传 (2026-07-25) - W19

- 📁 **TXT/MD 上传**: FileReader API + 1MB 限制
- ✅ **验证**: 类型 + 大小
- ✂️ **截断**: 自动 10000 字符
- 🏷️ **自动标题**: 从文件名提取
- 📈 396 → 419 单元测试 (+23)

详情见 [CHANGELOG v1.18.0](./docs/CHANGELOG.md#v1180---2026-07-25-w19)

## 📅 v1.19.0 - 学习日历 (2026-07-25) - W20

- 📅 **月历网格**: 6 周 × 7 天, 周日-周六
- 🔥 **热力图**: 5 等级配色 (灰/浅/中/深/极深)
- ⬅️ **月份切换**: 上一月/下一月/今天
- 📊 **月统计**: 动作总数/词总数/活跃天数
- 💡 **hover tooltip**: 日期 + 动作 + 词数
- 📈 419 → 440 单元测试 (+21)

详情见 [CHANGELOG v1.19.0](./docs/CHANGELOG.md#v1190---2026-07-25-w20)

## 📚 v1.20.0 - 生词本批量操作 (2026-07-25) - W21

- 📚 **批量入复习**: 复用 v1.11 复习队列 (SM-2 初始值)
- 📤 **批量导出 CSV**: word/translation/difficulty/addedAt
- ☑ **全选** / ⇄ **反选** 辅助
- 🗑 **批量删除** (原有 v0.14 增强)
- 📈 440 → 460 单元测试 (+20)

详情见 [CHANGELOG v1.20.0](./docs/CHANGELOG.md#v1200---2026-07-25-w21)

## 🏷️ v1.21.0 - 生词本标签 (2026-07-25) - W22

- 🗃️ **IDB v6**: `wordTags` 表 (compound index)
- 🏷️ **加 tag**: 逗号/分号/空格分隔, 去重, 小写化
- 🔍 **过滤**: 顶部按 tag 过滤
- 💡 **启发式**: 7 类建议 (work/travel/food/study/tech/sport/health)
- 🎨 **7 配色**: 哈希稳定
- 📈 460 → 496 单元测试 (+36)

详情见 [CHANGELOG v1.21.0](./docs/CHANGELOG.md#v1210---2026-07-25-w22)

## 🔍 v1.22.0 - 复习按 tag 过滤 (2026-07-25) - W23

- 🔍 **按 tag 复习**: 复用 v1.11 sortReviewQueue + v1.21 wordTags
- 📊 **due/total 计数**: 直观复习压力
- 🏷️ **配色循环**: 复用 getTagColor
- ⭐ **智能排序共存**: 不破坏 v1.11
- 📈 496 → 510 单元测试 (+14)

详情见 [CHANGELOG v1.22.0](./docs/CHANGELOG.md#v1220---2026-07-25-w23)

## 📄 v1.23.0 - PDF 上传 (2026-07-25) - W24

- 📄 **PDF 解析**: 懒加载 pdfjs-dist (open source, 0 成本)
- 🔐 **加密 PDF 检测**: 友好提示
- 📊 **页数显示**: "✓ PDF 解析完成 (15 页)"
- ⚡ **性能优化**: disableFontFace 提速 3-5x
- 🆕 **38 库** / 1 新依赖 / 526 测试 (+16)
- 🛡️ **0 catch (e: any) 残留** (v1.22 review 维持)

详情见 [CHANGELOG v1.23.0](./docs/CHANGELOG.md#v1230---2026-07-25-w24)
...
- **330+ commit / 24 release tag (v1.0.0 ~ v1.23.0)**
