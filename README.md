...
- **25 页面 + 32 组件 + 42 库 + 13000+ 行代码**
- **5334 词 + 465 词根 (全量 80.4% / Top 2k 86.3%) + 13234 例句 + 5 场景 + 5 听力 + 100 每日一句**
- **10 LLM (含 OpenRouter free) + 8 TTS (4 口音) + 8 翻译 + 3 自定义端点**
- **17 角色模式 (11 单 + 3 多人) + 20 成就 + 8 主题 + 4 字号 + 2 语言 + 7 学段 + 3 步 onboarding**
- **657 单元测试 + 16 闭环 (37 测试点) + 0 P0/P1**
- **130+ bug 修复** (含 v1.6 review 13 + v1.22 18 处 catch any + v1.36 3 处 + v1.40.1 2 处)
- **400+ commit / 42 release tag (v1.0.0 ~ v1.41.0)**
