...
[📦 v1.18.0 Release Notes](./docs/RELEASE_v1.18.0.md) ·
...
✅ **19 个版本量产** (v1.1.0 ~ v1.18.0, 3 producer 并行 1d 干完 3-6d 计划 × 12 轮)
✅ **419 单元测试 + 16 闭环集成测试** 全过 (104 → 419, +315)
...
- **280+ commit / 19 release tag (v1.0.0 ~ v1.18.0)**
