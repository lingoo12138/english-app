...
export const LESSONS: Lesson[] = [
  // === 1. 旅行 ===
  {
    ...
    emoji: '✈️',
    level: 'junior',
    summary: '机场值机、酒店入住、景点游览, 一家人去海边度假。',
    body: `Last summer, my family took a trip to the beach. We left home very early in the morning. At the airport, the driver helped us with the luggage. My father showed the ticket and passport to the staff.
...
In the afternoon, I meet my friend at the park. We sit on a bench, eat bread, and talk about life. The sun is warm, and the air is fresh. I feel very happy and relaxed on a day like this.`,
  ...
  // === 4. 情感 ===
  {
    ...
    emoji: '💖',
    level: 'junior',
    summary: '开心、难过、惊讶、平静, 记录一周的心情变化。',
    body: `This week, I feel many different feelings. On Monday, I was sad because I lost my favorite book. I looked for it everywhere, but I could not find it. I felt a little worried.
