...
const DICT: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    // v1.57.0 W52: 5 页面扩展 DICT 25 key
    'home.welcome': '欢迎回来',
    'home.streak_subtitle': '连续学习 N 天',
    'home.daily_summary': '今日要学 · 总完成',
    'plan.week_summary': '近 7 天完成',
    'plan.continue_streak': '保持连续',
    'plan.completion_rate': '完成率',
    'settings.theme': '主题',
    'settings.color': '颜色',
    'settings.contrast': '对比度',
    'settings.reset': '重置',
    'review.flip_back': '点击翻回正面',
    'review.correct': '认识',
    'review.incorrect': '不认识',
    'review.show_answer': '查看答案',
    'review.next_card': '下一张',
    'reports.total_words': '总词汇',
    'reports.total_sessions': '总会话',
    'reports.avg_accuracy': '平均准确率',
    'reports.this_week': '本周',
    'reports.this_month': '本月',
    'reports.daily_streak': '连续天数',
    'reports.weekly_chart': '周趋势',
    'reports.export': '导出',
    'reports.share': '分享',
  ...
  en: {
    ...
    'home.streak_subtitle': 'N-day streak',
    'home.daily_summary': 'Today · total',
    'plan.week_summary': '7-day summary',
    'plan.continue_streak': 'Keep it up',
    'plan.completion_rate': 'Completion',
    'settings.theme': 'Theme',
    'settings.color': 'Color',
    'settings.contrast': 'Contrast',
    'settings.reset': 'Reset',
    'review.flip_back': 'Click to flip back',
    'review.correct': 'Known',
    'review.incorrect': 'Unknown',
    'review.show_answer': 'Show answer',
    'review.next_card': 'Next',
    'reports.total_words': 'Total words',
    'reports.total_sessions': 'Total sessions',
    'reports.avg_accuracy': 'Avg accuracy',
    'reports.this_week': 'This week',
    'reports.this_month': 'This month',
    'reports.daily_streak': 'Streak',
    'reports.weekly_chart': 'Weekly',
