...
const LessonScorePage = lazy(() => import('./pages/LessonScorePage'))
...
function App() {
  ...
  // v1.40.0 W40: 暗色统一走 useStore, 不调 initDarkMode (避免 race + 死路径)
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    if (removed > 0 && import.meta.env.DEV) console.debug(`[plan] cleaned ${removed} plan-progress`)
  }, [])
  ...
  return (
    ...
    <Routes>
      <Route path="/" element={<Layout />}>
        ...
        <Route path="textbook/score" element={<LessonScorePage />} />
